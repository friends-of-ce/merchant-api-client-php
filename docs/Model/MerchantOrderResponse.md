...
**globalSalesChannelPluginInfoId** | **int** | The unique ID of the sales channel pluginInfoId. | [optional]
**globalSalesChannelPluginInfoName** | **string** | The name of the sales channel (pluginInfo) across all of ChannelEngine. | [optional]
**channelOrderSupport** | **string** | The type of orders the channel supports. | [optional]
**channelRefundSupport** | **string** | [Closed Beta Field] [Not Populated when you are not in the Closed Beta]  The type of refunds the channel supports. | [optional]
**channelReturnSupport** | [**\FriendsOfCE\Merchant\ApiClient\Model\ReturnSupport**](ReturnSupport.md) |  | [optional]
...
**shippingCostsVatRate** | **float** | The VAT rate of the shipping fee | [optional]
...
**bundleOrderLines** | [**\FriendsOfCE\Merchant\ApiClient\Model\MerchantBundleOrderLineResponse[]**](MerchantBundleOrderLineResponse.md) | Show only when order contain bundle products | [optional]
**serviceLines** | [**\FriendsOfCE\Merchant\ApiClient\Model\MerchantOrderServiceLineResponse[]**](MerchantOrderServiceLineResponse.md) | [Closed Beta] Service lines associated with this order. | [optional]
