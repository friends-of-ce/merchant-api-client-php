...
**pickupPointNumber** | **string** | The number of the pickup point. | [optional]
**pickupPointName** | **string** | The name of the pickup point. | [optional]
**addressType** | **string** | The type of the address. | [optional]
**gender** | **string** | Optional. The customer&#39;s gender. | [optional]
...
**streetName** | **string** | The name of the street (without house number information)  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used. | [optional]
**houseNr** | **string** | The house number  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used. | [optional]
**houseNrAddition** | **string** | Optional. Addition to the house number  If the address is: Groenhazengracht 2c, the address will be:  StreetName: Groenhazengracht  HouseNo: 2  HouseNrAddition: c  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used. | [optional]
