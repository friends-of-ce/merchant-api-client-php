...
class MerchantProductBundleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'price' => 'float',
        'parts' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantProductBundlePartResponse[]'
    ];
    ...
    */
     ...
     * Gets parts
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductBundlePartResponse[]|null
     */
     ...
     * Sets parts
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductBundlePartResponse[]|null $parts parts
     *
     * @return self
     */
    ...
    {
        if (is_null($parts)) {
            array_push($this->openAPINullablesSetToNull, 'parts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
