...
class MerchantProductExtraDataItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_IMAGEURL = 'IMAGEURL';
    ...
    */
    ...
    public function setFieldType($fieldType)
    {
        if (is_null($fieldType)) {
            array_push($this->openAPINullablesSetToNull, 'fieldType');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fieldType', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $languageIsoCode languageIsoCode
     *
     * @return self
     */
