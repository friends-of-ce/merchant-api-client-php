    ...
    */
    ...
    public function setReturnMethod($returnMethod)
    {
        ...
        if (!is_null($returnMethod) && (mb_strlen($returnMethod) > 50)) {
            throw new \InvalidArgumentException('invalid length for $returnMethod when calling MerchantShipmentRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($returnMethod) && (mb_strlen($returnMethod) < 0)) {
            throw new \InvalidArgumentException('invalid length for $returnMethod when calling MerchantShipmentRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setAirWaybillNo($airWaybillNo)
    {
        ...
        if (!is_null($airWaybillNo) && (mb_strlen($airWaybillNo) > 250)) {
            throw new \InvalidArgumentException('invalid length for $airWaybillNo when calling MerchantShipmentRequest., must be smaller than or equal to 250.');
        }
        if (!is_null($airWaybillNo) && (mb_strlen($airWaybillNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $airWaybillNo when calling MerchantShipmentRequest., must be bigger than or equal to 0.');
        }
