...
class IVendorParty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $taxRegistrationType taxRegistrationType
     *
     * @return self
     */
    public function setTaxRegistrationType($taxRegistrationType)
    {
        if (is_null($taxRegistrationType)) {
            array_push($this->openAPINullablesSetToNull, 'taxRegistrationType');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('taxRegistrationType', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
