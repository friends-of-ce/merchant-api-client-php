...
/**
 * IVendorParty Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class IVendorParty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IVendorParty';
    ...
    {
        $this->setIfExists('partyId', $data ?? [], null);
    ...
    */
     ...
     * Sets partyId
     *
     * @param string|null $partyId partyId
     *
     * @return self
     */
    ...
    {
        if (is_null($partyId)) {
            array_push($this->openAPINullablesSetToNull, 'partyId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partyId', $nullablesSetToNull);
            if ($index !== FALSE) {
