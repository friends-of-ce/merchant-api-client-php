...
class MerchantProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'isActive' => 'bool',
        'extraData' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantProductExtraDataItemResponse[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['segment']) && (mb_strlen($this->container['segment']) > 256)) {
            $invalidProperties[] = "invalid value for 'segment', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['segment']) && (mb_strlen($this->container['segment']) < 0)) {
            $invalidProperties[] = "invalid value for 'segment', the character length must be bigger than or equal to 0.";
        }
     ...
     * Gets extraData
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductExtraDataItemResponse[]|null
     */
     ...
     * Sets extraData
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductExtraDataItemResponse[]|null $extraData extraData
     *
     * @return self
     */
     ...
     *
     * @param string|null $parentMerchantProductNo A unique identifier of the parent product. (parent sku).
     *
     * @return self
     */
     ...
     *
     * @param string|null $parentMerchantProductNo2 A unique identifier of the grandparent product. (grandparent sku).
     *
     * @return self
     */
    ...
    public function setSegment($segment)
    {
        ...
        if (!is_null($segment) && (mb_strlen($segment) > 256)) {
            throw new \InvalidArgumentException('invalid length for $segment when calling MerchantProductResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($segment) && (mb_strlen($segment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $segment when calling MerchantProductResponse., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $manufacturerProductNumber manufacturerProductNumber
     *
     * @return self
     */
    ...
    public function setMinPrice($minPrice)
    {
        ...
        if (!is_null($minPrice) && ($minPrice < 0)) {
            throw new \InvalidArgumentException('invalid value for $minPrice when calling MerchantProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxPrice($maxPrice)
    {
        ...
        if (!is_null($maxPrice) && ($maxPrice < 0)) {
            throw new \InvalidArgumentException('invalid value for $maxPrice when calling MerchantProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setVatRateType($vatRateType)
    {
        ...
        $allowedValues = $this->getVatRateTypeAllowableValues();
        if (!in_array($vatRateType, $allowedValues, true)) {
     ...
     * Sets isFrozen
     *
     * @param bool|null $isFrozen isFrozen
     *
     * @return self
     */
