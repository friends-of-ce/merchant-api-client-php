...
class IPurchaseOrderShipmentByFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipmentWeightUnitOfMeasure' => 'string',
        'shipmentWeight' => 'float',
        'shipmentVolumeUnitOfMeasure' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        'shipmentWeightUnitOfMeasure' => true,
        'shipmentWeight' => true,
        'shipmentVolumeUnitOfMeasure' => true,
        'shipmentVolume' => true,
    ...
    public const SHIPMENT_WEIGHT_UNIT_OF_MEASURE_GRAMS = 'GRAMS';
    public const SHIPMENT_WEIGHT_UNIT_OF_MEASURE_KILOGRAMS = 'KILOGRAMS';
    public const SHIPMENT_WEIGHT_UNIT_OF_MEASURE_OUNCES = 'OUNCES';
    public const SHIPMENT_WEIGHT_UNIT_OF_MEASURE_POUNDS = 'POUNDS';
    public const SHIPMENT_VOLUME_UNIT_OF_MEASURE_FEET = 'CUBIC_FEET';
    public const SHIPMENT_VOLUME_UNIT_OF_MEASURE_INCHES = 'CUBIC_INCHES';
    public const SHIPMENT_VOLUME_UNIT_OF_MEASURE_METER = 'CUBIC_METER';
    public const SHIPMENT_VOLUME_UNIT_OF_MEASURE_YARD = 'CUBIC_YARD';
    public const LAST_EXPORT_STATUS_NONE = 'NONE';
    public const LAST_EXPORT_STATUS_IN_PROGRESS = 'IN_PROGRESS';
    public const LAST_EXPORT_STATUS_SUCCESS = 'SUCCESS';
    public const LAST_EXPORT_STATUS_FAILURE = 'FAILURE';
     ...
     * @return string[]
     */
    public function getShipmentWeightUnitOfMeasureAllowableValues()
    {
        return [
            self::SHIPMENT_WEIGHT_UNIT_OF_MEASURE_GRAMS,
            self::SHIPMENT_WEIGHT_UNIT_OF_MEASURE_KILOGRAMS,
            self::SHIPMENT_WEIGHT_UNIT_OF_MEASURE_OUNCES,
            self::SHIPMENT_WEIGHT_UNIT_OF_MEASURE_POUNDS,
        ];
    }
     ...
     * @return string[]
     */
    public function getShipmentVolumeUnitOfMeasureAllowableValues()
    {
        return [
            self::SHIPMENT_VOLUME_UNIT_OF_MEASURE_FEET,
            self::SHIPMENT_VOLUME_UNIT_OF_MEASURE_INCHES,
            self::SHIPMENT_VOLUME_UNIT_OF_MEASURE_METER,
            self::SHIPMENT_VOLUME_UNIT_OF_MEASURE_YARD,
        ];
    }
     ...
     * @return string[]
     */
    public function getLastExportStatusAllowableValues()
    {
        return [
            self::LAST_EXPORT_STATUS_NONE,
            self::LAST_EXPORT_STATUS_IN_PROGRESS,
            self::LAST_EXPORT_STATUS_SUCCESS,
            self::LAST_EXPORT_STATUS_FAILURE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getShipmentWeightUnitOfMeasureAllowableValues();
        if (!is_null($this->container['shipmentWeightUnitOfMeasure']) && !in_array($this->container['shipmentWeightUnitOfMeasure'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'shipmentWeightUnitOfMeasure', must be one of '%s'",
                $this->container['shipmentWeightUnitOfMeasure'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getShipmentVolumeUnitOfMeasureAllowableValues();
        if (!is_null($this->container['shipmentVolumeUnitOfMeasure']) && !in_array($this->container['shipmentVolumeUnitOfMeasure'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'shipmentVolumeUnitOfMeasure', must be one of '%s'",
                $this->container['shipmentVolumeUnitOfMeasure'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getLastExportStatusAllowableValues();
        if (!is_null($this->container['lastExportStatus']) && !in_array($this->container['lastExportStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'lastExportStatus', must be one of '%s'",
                $this->container['lastExportStatus'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $shipmentWeightUnitOfMeasure Unit of measure for the shipment's weight
     *
     * @return self
     */
    public function setShipmentWeightUnitOfMeasure($shipmentWeightUnitOfMeasure)
    {
        if (is_null($shipmentWeightUnitOfMeasure)) {
            array_push($this->openAPINullablesSetToNull, 'shipmentWeightUnitOfMeasure');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipmentWeightUnitOfMeasure', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getShipmentWeightUnitOfMeasureAllowableValues();
        if (!is_null($shipmentWeightUnitOfMeasure) && !in_array($shipmentWeightUnitOfMeasure, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'shipmentWeightUnitOfMeasure', must be one of '%s'",
     ...
     *
     * @param string|null $shipmentVolumeUnitOfMeasure Unit of measure for the shipment's volume
     *
     * @return self
     */
    public function setShipmentVolumeUnitOfMeasure($shipmentVolumeUnitOfMeasure)
    {
        if (is_null($shipmentVolumeUnitOfMeasure)) {
            array_push($this->openAPINullablesSetToNull, 'shipmentVolumeUnitOfMeasure');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipmentVolumeUnitOfMeasure', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getShipmentVolumeUnitOfMeasureAllowableValues();
        if (!is_null($shipmentVolumeUnitOfMeasure) && !in_array($shipmentVolumeUnitOfMeasure, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'shipmentVolumeUnitOfMeasure', must be one of '%s'",
     ...
     *
     * @param string|null $lastExportStatus Status of the last export to the channel
     *
     * @return self
     */
    public function setLastExportStatus($lastExportStatus)
    {
        ...
        $allowedValues = $this->getLastExportStatusAllowableValues();
        if (!in_array($lastExportStatus, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'lastExportStatus', must be one of '%s'",
                    $lastExportStatus,
