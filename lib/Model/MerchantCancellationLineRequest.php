 ...
 */
class MerchantCancellationLineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantCancellationLineRequest';
    ...
    */
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        ...
        if ((mb_strlen($merchantProductNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantCancellationLineRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($merchantProductNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantCancellationLineRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderLineId($orderLineId)
    {
        if (is_null($orderLineId)) {
            array_push($this->openAPINullablesSetToNull, 'orderLineId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('orderLineId', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling MerchantCancellationLineRequest., must be bigger than or equal to 0.');
        }
