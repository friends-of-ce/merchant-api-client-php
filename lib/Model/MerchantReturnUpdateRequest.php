 ...
 */
class MerchantReturnUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantReturnUpdateRequest';
    ...
    protected static $openAPITypes = [
        'returnId' => 'int',
        'lines' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantReturnLineUpdateRequest[]'
    ];
    ...
    */
     ...
     * Gets lines
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantReturnLineUpdateRequest[]
     */
     ...
     * Sets lines
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantReturnLineUpdateRequest[] $lines lines
     *
     * @return self
     */
    public function setLines($lines)
    {
        ...
        if ((count($lines) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lines when calling MerchantReturnUpdateRequest., number of items must be greater than or equal to 1.');
        }
