...
class MerchantReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets trackTraceNo
     *
     * @param string|null $trackTraceNo Tracking number for the return.
     *
     * @return self
     */
    public function setTrackTraceNo($trackTraceNo)
    {
        ...
        if (!is_null($trackTraceNo) && (mb_strlen($trackTraceNo) > 50)) {
            throw new \InvalidArgumentException('invalid length for $trackTraceNo when calling MerchantReturnRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($trackTraceNo) && (mb_strlen($trackTraceNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $trackTraceNo when calling MerchantReturnRequest., must be bigger than or equal to 0.');
        }
