...
/**
 * SupportOrderAddress Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SupportOrderAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportOrderAddress';
    ...
    public const GENDER_NOT_APPLICABLE = 'NOT_APPLICABLE';
    ...
    */
     ...
     * Sets gender
     *
     * @param string|null $gender Optional. The customer's gender.
     *
     * @return self
     */
    ...
    public function setCompanyName($companyName)
    {
        ...
        if (!is_null($companyName) && (mb_strlen($companyName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($companyName) && (mb_strlen($companyName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setFirstName($firstName)
    {
        ...
        if (!is_null($firstName) && (mb_strlen($firstName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($firstName) && (mb_strlen($firstName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if (!is_null($lastName) && (mb_strlen($lastName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($lastName) && (mb_strlen($lastName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
     ...
     * Sets streetName
     *
     * @param string|null $streetName The name of the street (without house number information)  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used.
     *
     * @return self
     */
    public function setStreetName($streetName)
    {
        ...
        if (!is_null($streetName) && (mb_strlen($streetName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $streetName when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($streetName) && (mb_strlen($streetName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $streetName when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
     ...
     * Sets houseNr
     *
     * @param string|null $houseNr The house number  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used.
     *
     * @return self
     */
    public function setHouseNr($houseNr)
    {
        ...
        if (!is_null($houseNr) && (mb_strlen($houseNr) > 50)) {
            throw new \InvalidArgumentException('invalid length for $houseNr when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($houseNr) && (mb_strlen($houseNr) < 0)) {
            throw new \InvalidArgumentException('invalid length for $houseNr when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $houseNrAddition Optional. Addition to the house number  If the address is: Groenhazengracht 2c, the address will be:  StreetName: Groenhazengracht  HouseNo: 2  HouseNrAddition: c  This field might be empty if address validation is disabled in ChannelEngine or Line1/Line2 is used.
     *
     * @return self
     */
    public function setHouseNrAddition($houseNrAddition)
    {
        ...
        if (!is_null($houseNrAddition) && (mb_strlen($houseNrAddition) > 50)) {
            throw new \InvalidArgumentException('invalid length for $houseNrAddition when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($houseNrAddition) && (mb_strlen($houseNrAddition) < 0)) {
            throw new \InvalidArgumentException('invalid length for $houseNrAddition when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 50)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SupportOrderAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($region) && (mb_strlen($region) < 0)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryIso($countryIso)
    {
        ...
        if (!is_null($countryIso) && (mb_strlen($countryIso) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryIso when calling SupportOrderAddress., must be smaller than or equal to 2.');
        }
        if (!is_null($countryIso) && (mb_strlen($countryIso) < 0)) {
            throw new \InvalidArgumentException('invalid length for $countryIso when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setOriginal($original)
    {
        ...
        if (!is_null($original) && (mb_strlen($original) > 256)) {
            throw new \InvalidArgumentException('invalid length for $original when calling SupportOrderAddress., must be smaller than or equal to 256.');
        }
        if (!is_null($original) && (mb_strlen($original) < 0)) {
            throw new \InvalidArgumentException('invalid length for $original when calling SupportOrderAddress., must be bigger than or equal to 0.');
        }
