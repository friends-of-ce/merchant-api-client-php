...
class MerchantCancellationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REASON_CODE_NOT_IN_STOCK = 'NOT_IN_STOCK';
    public const REASON_CODE_DAMAGED = 'DAMAGED';
    public const REASON_CODE_INCOMPLETE = 'INCOMPLETE';
    public const REASON_CODE_CLIENT_CANCELLED = 'CLIENT_CANCELLED';
    public const REASON_CODE_INVALID_ADDRESS = 'INVALID_ADDRESS';
    ...
    */
     ...
     * Sets reasonCode
     *
     * @param string|null $reasonCode Reason code for cancellation.
     *
     * @return self
     */
    public function setReasonCode($reasonCode)
    {
        if (is_null($reasonCode)) {
            array_push($this->openAPINullablesSetToNull, 'reasonCode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
