...
class IPurchaseOrderByFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_REGULAR_ORDER = 'REGULAR_ORDER';
    public const TYPE_CONSIGNED_ORDER = 'CONSIGNED_ORDER';
    public const TYPE_NEW_PRODUCT_INTRODUCTION = 'NEW_PRODUCT_INTRODUCTION';
    ...
    {
        return [
            self::TYPE_REGULAR_ORDER,
            self::TYPE_CONSIGNED_ORDER,
            self::TYPE_NEW_PRODUCT_INTRODUCTION,
            self::TYPE_RUSH_ORDER,
        ];
    }
