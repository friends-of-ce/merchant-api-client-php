...
class NotificationType
{
    ...
    public const ORDER_FALLBACK_TO_DEFAULT_STOCKLOCATION = 'ORDER_FALLBACK_TO_DEFAULT_STOCKLOCATION';
    ...
    public const CHANNEL_PURCHASE_ORDER_LINE_CHANGED = 'CHANNEL_PURCHASE_ORDER_LINE_CHANGED';

    public const CHANNEL_PURCHASE_ORDER_LINE_CANCELLED = 'CHANNEL_PURCHASE_ORDER_LINE_CANCELLED';

    public const CHANNEL_PURCHASE_ORDER_ACKNOWLEDGEMENT_FAILED = 'CHANNEL_PURCHASE_ORDER_ACKNOWLEDGEMENT_FAILED';

    public const CHANNEL_PURCHASE_ORDER_SHIPMENT_EXPORT_FAILED = 'CHANNEL_PURCHASE_ORDER_SHIPMENT_EXPORT_FAILED';

    public const CHANNEL_PURCHASE_ORDER_INVOICE_CREATION_FAILED = 'CHANNEL_PURCHASE_ORDER_INVOICE_CREATION_FAILED';
    ...
    public const PRODUCT_IMPORT_FEEDS_SUCCESS = 'PRODUCT_IMPORT_FEEDS_SUCCESS';

    public const SETTLEMENT_EXPORT_FAILED = 'SETTLEMENT_EXPORT_FAILED';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::ORDER_FALLBACK_TO_DEFAULT_STOCKLOCATION,
            ...
            self::CHANNEL_PURCHASE_ORDER_LINE_CHANGED,
            self::CHANNEL_PURCHASE_ORDER_LINE_CANCELLED,
            self::CHANNEL_PURCHASE_ORDER_ACKNOWLEDGEMENT_FAILED,
            self::CHANNEL_PURCHASE_ORDER_SHIPMENT_EXPORT_FAILED,
            self::CHANNEL_PURCHASE_ORDER_INVOICE_CREATION_FAILED,
            self::CHANNEL_KPI_TARGET_MISSED,
            self::LATE_UNSHIPPED_ORDERS,
            self::FEED_ENABLED,
            self::FEED_DISABLED,
            self::PRODUCT_IMPORT_FEEDS_SUCCESS,
            self::SETTLEMENT_EXPORT_FAILED
        ];
    }
}
