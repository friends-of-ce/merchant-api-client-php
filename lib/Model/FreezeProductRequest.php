...
/**
 * FreezeProductRequest Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class FreezeProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreezeProductRequest';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'action' => '\FriendsOfCE\Merchant\ApiClient\Model\FreezingActionRequest'
    ];
    ...
    */
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        ...
        if ((mb_strlen($merchantProductNo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling FreezeProductRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling FreezeProductRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets action
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\FreezingActionRequest
     */
     ...
     * Sets action
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\FreezingActionRequest $action action
     *
     * @return self
     */
