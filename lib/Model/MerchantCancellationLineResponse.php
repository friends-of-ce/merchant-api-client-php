...
class MerchantCancellationLineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique cancellation line identifier used by ChannelEngine.
     *
     * @return self
     */
     ...
     * Sets orderLineId
     *
     * @param int|null $orderLineId The unique order line identifier used by ChannelEngine.
     *
     * @return self
     */
