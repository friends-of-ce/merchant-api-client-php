...
class MerchantReturnResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Status of the return
     *
     * @return self
     */
     ...
     * Sets trackTraceNo
     *
     * @param string|null $trackTraceNo Track Trace No of the return.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason The reason code of the return.
     *
     * @return self
     */
