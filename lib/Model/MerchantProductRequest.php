...
class MerchantProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $parentMerchantProductNo2 parentMerchantProductNo2
     *
     * @return self
     */
     ...
     * Sets extraData
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductExtraDataItemRequest[]|null $extraData extraData
     *
     * @return self
     */
    ...
    public function setSegment($segment)
    {
        ...
        if (!is_null($segment) && (mb_strlen($segment) > 256)) {
            throw new \InvalidArgumentException('invalid length for $segment when calling MerchantProductRequest., must be smaller than or equal to 256.');
        }
        if (!is_null($segment) && (mb_strlen($segment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $segment when calling MerchantProductRequest., must be bigger than or equal to 0.');
        }
