...
/**
 * MerchantUpdateProductBundleRequest Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MerchantUpdateProductBundleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantUpdateProductBundleRequest';
    ...
    protected static $openAPITypes = [
        ...
        'parts' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantUpdateProductBundlePartRequest[]'
    ];
    ...
    */
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        ...
        if ((mb_strlen($merchantProductNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantUpdateProductBundleRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($merchantProductNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantUpdateProductBundleRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets parts
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantUpdateProductBundlePartRequest[]
     */
     ...
     * Sets parts
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantUpdateProductBundlePartRequest[] $parts The array for the parts making up the bundle
     *
     * @return self
     */
