...
class MerchantOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'globalChannelId' => 'int',
        'globalSalesChannelPluginInfoId' => 'int',
        'globalSalesChannelPluginInfoName' => 'string',
        'channelOrderSupport' => 'string',
        'channelRefundSupport' => 'string',
        'channelReturnSupport' => '\FriendsOfCE\Merchant\ApiClient\Model\ReturnSupport',
        ...
        'originalSubTotalFee' => 'float',
        'subTotalFee' => 'float',
        'originalOrderFee' => 'float',
        'orderFee' => 'float',
        'originalTotalFee' => 'float',
        'totalFee' => 'float',
        'lines' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantOrderLineResponse[]',
        'bundleOrderLines' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantBundleOrderLineResponse[]',
    ...
    protected static $openAPIFormats = [
        ...
        'globalSalesChannelPluginInfoId' => 'int32',
        'globalSalesChannelPluginInfoName' => null,
        'channelOrderSupport' => null,
        'channelRefundSupport' => null,
        'channelReturnSupport' => null,
        'channelOrderNo' => null,
        ...
        'originalSubTotalFee' => 'decimal',
        'subTotalFee' => 'decimal',
        'originalOrderFee' => 'decimal',
        'orderFee' => 'decimal',
        'originalTotalFee' => 'decimal',
        'totalFee' => 'decimal',
        'lines' => null,
        'bundleOrderLines' => null,
        'serviceLines' => null,
        'phone' => null,
        'email' => null,
        'languageCode' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'globalSalesChannelPluginInfoId' => true,
        'globalSalesChannelPluginInfoName' => true,
        'channelOrderSupport' => false,
        'channelRefundSupport' => true,
        'channelReturnSupport' => false,
        'channelOrderNo' => true,
        ...
        'originalSubTotalFee' => false,
        'subTotalFee' => false,
        'originalOrderFee' => false,
        'orderFee' => false,
        'originalTotalFee' => false,
        'totalFee' => false,
        'lines' => true,
        'bundleOrderLines' => true,
        'serviceLines' => true,
        'phone' => true,
        'email' => false,
        'languageCode' => true,
    ...
    protected static $attributeMap = [
        ...
        'globalSalesChannelPluginInfoId' => 'GlobalSalesChannelPluginInfoId',
        'globalSalesChannelPluginInfoName' => 'GlobalSalesChannelPluginInfoName',
        'channelOrderSupport' => 'ChannelOrderSupport',
        'channelRefundSupport' => 'ChannelRefundSupport',
        'channelReturnSupport' => 'ChannelReturnSupport',
        ...
        'shippingCostsVatRate' => 'ShippingCostsVatRate',
        ...
        'totalFee' => 'TotalFee',
        'lines' => 'Lines',
        'bundleOrderLines' => 'BundleOrderLines',
    ...
    protected static $setters = [
        ...
        'globalSalesChannelPluginInfoId' => 'setGlobalSalesChannelPluginInfoId',
        'globalSalesChannelPluginInfoName' => 'setGlobalSalesChannelPluginInfoName',
        'channelOrderSupport' => 'setChannelOrderSupport',
        'channelRefundSupport' => 'setChannelRefundSupport',
        'channelReturnSupport' => 'setChannelReturnSupport',
        ...
        'shippingCostsVatRate' => 'setShippingCostsVatRate',
        ...
        'originalSubTotalFee' => 'setOriginalSubTotalFee',
        'subTotalFee' => 'setSubTotalFee',
        'originalOrderFee' => 'setOriginalOrderFee',
        'orderFee' => 'setOrderFee',
        'originalTotalFee' => 'setOriginalTotalFee',
        'totalFee' => 'setTotalFee',
        'lines' => 'setLines',
        'bundleOrderLines' => 'setBundleOrderLines',
    ...
    protected static $getters = [
        ...
        'globalSalesChannelPluginInfoId' => 'getGlobalSalesChannelPluginInfoId',
        'globalSalesChannelPluginInfoName' => 'getGlobalSalesChannelPluginInfoName',
        'channelOrderSupport' => 'getChannelOrderSupport',
        'channelRefundSupport' => 'getChannelRefundSupport',
        'channelReturnSupport' => 'getChannelReturnSupport',
        ...
        'shippingCostsVatRate' => 'getShippingCostsVatRate',
        ...
        'originalSubTotalFee' => 'getOriginalSubTotalFee',
        'subTotalFee' => 'getSubTotalFee',
        'originalOrderFee' => 'getOriginalOrderFee',
        'orderFee' => 'getOrderFee',
        'originalTotalFee' => 'getOriginalTotalFee',
        'totalFee' => 'getTotalFee',
        'lines' => 'getLines',
        'bundleOrderLines' => 'getBundleOrderLines',
    ...
    public const CHANNEL_ORDER_SUPPORT_NONE = 'NONE';
    public const CHANNEL_ORDER_SUPPORT_ORDERS = 'ORDERS';
    public const CHANNEL_ORDER_SUPPORT_SPLIT_ORDERS = 'SPLIT_ORDERS';
    public const CHANNEL_ORDER_SUPPORT_SPLIT_ORDER_LINES = 'SPLIT_ORDER_LINES';
    public const CHANNEL_REFUND_SUPPORT_NONE = 'NONE';
    public const CHANNEL_REFUND_SUPPORT_FULL_ORDER = 'FULL_ORDER';
    public const CHANNEL_REFUND_SUPPORT_FULL_LINE = 'FULL_LINE';
    public const CHANNEL_REFUND_SUPPORT_PARTIAL_LINE = 'PARTIAL_LINE';
    public const CHANNEL_REFUND_SUPPORT_CUSTOM_AMOUNT = 'CUSTOM_AMOUNT';
    public const CHANNEL_REFUND_SUPPORT_RETURN_ONLY = 'RETURN_ONLY';
     ...
     * @return string[]
     */
    public function getChannelRefundSupportAllowableValues()
    {
        return [
            self::CHANNEL_REFUND_SUPPORT_NONE,
            self::CHANNEL_REFUND_SUPPORT_FULL_ORDER,
            self::CHANNEL_REFUND_SUPPORT_FULL_LINE,
            self::CHANNEL_REFUND_SUPPORT_PARTIAL_LINE,
            self::CHANNEL_REFUND_SUPPORT_CUSTOM_AMOUNT,
            self::CHANNEL_REFUND_SUPPORT_RETURN_ONLY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('globalSalesChannelPluginInfoId', $data ?? [], null);
        $this->setIfExists('globalSalesChannelPluginInfoName', $data ?? [], null);
        $this->setIfExists('channelOrderSupport', $data ?? [], null);
        $this->setIfExists('channelRefundSupport', $data ?? [], null);
        $this->setIfExists('channelReturnSupport', $data ?? [], null);
        ...
        $this->setIfExists('shippingCostsVatRate', $data ?? [], null);
        ...
        $this->setIfExists('originalSubTotalFee', $data ?? [], null);
        $this->setIfExists('subTotalFee', $data ?? [], null);
        $this->setIfExists('originalOrderFee', $data ?? [], null);
        $this->setIfExists('orderFee', $data ?? [], null);
        $this->setIfExists('originalTotalFee', $data ?? [], null);
        $this->setIfExists('totalFee', $data ?? [], null);
        $this->setIfExists('lines', $data ?? [], null);
        $this->setIfExists('bundleOrderLines', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['channelOrderSupport']) && !in_array($this->container['channelOrderSupport'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'channelOrderSupport', must be one of '%s'",
                $this->container['channelOrderSupport'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getChannelRefundSupportAllowableValues();
        if (!is_null($this->container['channelRefundSupport']) && !in_array($this->container['channelRefundSupport'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'channelRefundSupport', must be one of '%s'",
                $this->container['channelRefundSupport'],
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['languageCode']) && (mb_strlen($this->container['languageCode']) < 0)) {
            $invalidProperties[] = "invalid value for 'languageCode', the character length must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets globalSalesChannelPluginInfoId
     *
     * @return int|null
     */
    public function getGlobalSalesChannelPluginInfoId()
    {
        return $this->container['globalSalesChannelPluginInfoId'];
    }

    /**
     * Sets globalSalesChannelPluginInfoId
     *
     * @param int|null $globalSalesChannelPluginInfoId The unique ID of the sales channel pluginInfoId.
     *
     * @return self
     */
    public function setGlobalSalesChannelPluginInfoId($globalSalesChannelPluginInfoId)
    {
        if (is_null($globalSalesChannelPluginInfoId)) {
            array_push($this->openAPINullablesSetToNull, 'globalSalesChannelPluginInfoId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('globalSalesChannelPluginInfoId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['globalSalesChannelPluginInfoId'] = $globalSalesChannelPluginInfoId;

        return $this;
    }

    /**
     * Gets globalSalesChannelPluginInfoName
     *
     * @return string|null
     */
    public function getGlobalSalesChannelPluginInfoName()
    {
        return $this->container['globalSalesChannelPluginInfoName'];
    }

    /**
     * Sets globalSalesChannelPluginInfoName
     *
     * @param string|null $globalSalesChannelPluginInfoName The name of the sales channel (pluginInfo) across all of ChannelEngine.
     *
     * @return self
     */
    public function setGlobalSalesChannelPluginInfoName($globalSalesChannelPluginInfoName)
    {
        if (is_null($globalSalesChannelPluginInfoName)) {
            array_push($this->openAPINullablesSetToNull, 'globalSalesChannelPluginInfoName');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('globalSalesChannelPluginInfoName', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['globalSalesChannelPluginInfoName'] = $globalSalesChannelPluginInfoName;
     ...
     *
     * @param string|null $channelOrderSupport The type of orders the channel supports.
     *
     * @return self
     */
    public function setChannelOrderSupport($channelOrderSupport)
    {
        ...
        $allowedValues = $this->getChannelOrderSupportAllowableValues();
        if (!in_array($channelOrderSupport, $allowedValues, true)) {
    ...
    /**
     * Gets channelRefundSupport
     *
     * @return string|null
     */
    public function getChannelRefundSupport()
    {
        return $this->container['channelRefundSupport'];
    }

    /**
     * Sets channelRefundSupport
     *
     * @param string|null $channelRefundSupport [Closed Beta Field] [Not Populated when you are not in the Closed Beta]  The type of refunds the channel supports.
     *
     * @return self
     */
    public function setChannelRefundSupport($channelRefundSupport)
    {
        if (is_null($channelRefundSupport)) {
            array_push($this->openAPINullablesSetToNull, 'channelRefundSupport');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('channelRefundSupport', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getChannelRefundSupportAllowableValues();
        if (!is_null($channelRefundSupport) && !in_array($channelRefundSupport, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'channelRefundSupport', must be one of '%s'",
        ...
        $this->container['channelRefundSupport'] = $channelRefundSupport;

        return $this;
    }

    /**
     * Gets channelReturnSupport
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\ReturnSupport|null
     */
    public function getChannelReturnSupport()
    {
        return $this->container['channelReturnSupport'];
    }

    /**
     * Sets channelReturnSupport
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\ReturnSupport|null $channelReturnSupport channelReturnSupport
     *
     * @return self
     */
    public function setChannelReturnSupport($channelReturnSupport)
    {
        if (is_null($channelReturnSupport)) {
            throw new \InvalidArgumentException('non-nullable channelReturnSupport cannot be null');
        }
        $this->container['channelReturnSupport'] = $channelReturnSupport;
     ...
     * Sets isTest
     *
     * @param bool|null $isTest Indicating whether the order is a test order.
     *
     * @return self
     */
     ...
     * Sets closedAt
     *
     * @param \DateTime|null $closedAt The date the order was last updated in ChannelEngine.
     *
     * @return self
     */
    ...
    /**
     * Gets shippingCostsVatRate
     *
     * @return float|null
     */
    public function getShippingCostsVatRate()
    {
        return $this->container['shippingCostsVatRate'];
    }

    /**
     * Sets shippingCostsVatRate
     *
     * @param float|null $shippingCostsVatRate The VAT rate of the shipping fee
     *
     * @return self
     */
    public function setShippingCostsVatRate($shippingCostsVatRate)
    {
        if (is_null($shippingCostsVatRate)) {
            array_push($this->openAPINullablesSetToNull, 'shippingCostsVatRate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shippingCostsVatRate', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['shippingCostsVatRate'] = $shippingCostsVatRate;
    ...
    /**
     * Gets originalSubTotalFee
     *
     * @return float|null
     */
    public function getOriginalSubTotalFee()
    {
        return $this->container['originalSubTotalFee'];
    }

    /**
     * Sets originalSubTotalFee
     *
     * @param float|null $originalSubTotalFee The sum of the fees on the order lines  (in the currency in which the order was paid for, see CurrencyCode).
     *
     * @return self
     */
    public function setOriginalSubTotalFee($originalSubTotalFee)
    {
        if (is_null($originalSubTotalFee)) {
            throw new \InvalidArgumentException('non-nullable originalSubTotalFee cannot be null');
        }
        $this->container['originalSubTotalFee'] = $originalSubTotalFee;
     ...
     * @return float|null
     */
    public function getSubTotalFee()
    {
        return $this->container['subTotalFee'];
    }

    /**
     * Sets subTotalFee
     *
     * @param float|null $subTotalFee The sum of the fees on the order lines  (in the shop's base currency calculated using the exchange rate at the time of ordering).
     *
     * @return self
     */
    public function setSubTotalFee($subTotalFee)
    {
        if (is_null($subTotalFee)) {
            throw new \InvalidArgumentException('non-nullable subTotalFee cannot be null');
        }
        $this->container['subTotalFee'] = $subTotalFee;

        return $this;
    }

    /**
     * Gets originalOrderFee
     *
     * @return float|null
     */
    public function getOriginalOrderFee()
    {
        return $this->container['originalOrderFee'];
    }

    /**
     * Sets originalOrderFee
     *
     * @param float|null $originalOrderFee The fee on order itself (besides the fees on the order lines)  (in the currency in which the order was paid for, see CurrencyCode).
     *
     * @return self
     */
    public function setOriginalOrderFee($originalOrderFee)
    {
        if (is_null($originalOrderFee)) {
            throw new \InvalidArgumentException('non-nullable originalOrderFee cannot be null');
        }
        $this->container['originalOrderFee'] = $originalOrderFee;
     ...
     * Sets orderFee
     *
     * @param float|null $orderFee The fee on order itself (besides the fees on the order lines)  (in the shop's base currency calculated using the exchange rate at the time of ordering).
     *
     * @return self
     */
    ...
    /**
     * Gets originalTotalFee
     *
     * @return float|null
     */
    public function getOriginalTotalFee()
    {
        return $this->container['originalTotalFee'];
    }

    /**
     * Sets originalTotalFee
     *
     * @param float|null $originalTotalFee The total fee: the fees on the order lines + the fee on the order itself  (in the currency in which the order was paid for, see CurrencyCode).
     *
     * @return self
     */
    public function setOriginalTotalFee($originalTotalFee)
    {
        if (is_null($originalTotalFee)) {
            throw new \InvalidArgumentException('non-nullable originalTotalFee cannot be null');
        }
        $this->container['originalTotalFee'] = $originalTotalFee;
     ...
     * Sets totalFee
     *
     * @param float|null $totalFee The total fee: the fees on the order lines + the fee on the order itself  (in the shop's base currency calculated using the exchange rate at the time of ordering).
     *
     * @return self
     */
    ...
    /**
     * Gets bundleOrderLines
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantBundleOrderLineResponse[]|null
     */
    public function getBundleOrderLines()
    {
        return $this->container['bundleOrderLines'];
    }

    /**
     * Sets bundleOrderLines
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantBundleOrderLineResponse[]|null $bundleOrderLines Show only when order contain bundle products
     *
     * @return self
     */
    public function setBundleOrderLines($bundleOrderLines)
    {
        if (is_null($bundleOrderLines)) {
            array_push($this->openAPINullablesSetToNull, 'bundleOrderLines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bundleOrderLines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['bundleOrderLines'] = $bundleOrderLines;
     ...
     * Sets serviceLines
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantOrderServiceLineResponse[]|null $serviceLines [Closed Beta] Service lines associated with this order.
     *
     * @return self
     */
     ...
     * Sets languageCode
     *
     * @param string|null $languageCode The language of the order. Has to be a 2-letter ISO language code.
     *
     * @return self
     */
    public function setLanguageCode($languageCode)
    {
        ...
        if (!is_null($languageCode) && (mb_strlen($languageCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $languageCode when calling MerchantOrderResponse., must be smaller than or equal to 2.');
        }
        if (!is_null($languageCode) && (mb_strlen($languageCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $languageCode when calling MerchantOrderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling MerchantOrderResponse., must be bigger than or equal to 3.');
        }
