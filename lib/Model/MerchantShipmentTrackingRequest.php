...
class MerchantShipmentTrackingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets returnMethod
     *
     * @param string|null $returnMethod Return method (return carrier).
     *
     * @return self
     */
    public function setReturnMethod($returnMethod)
    {
        ...
        if (!is_null($returnMethod) && (mb_strlen($returnMethod) > 50)) {
            throw new \InvalidArgumentException('invalid length for $returnMethod when calling MerchantShipmentTrackingRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($returnMethod) && (mb_strlen($returnMethod) < 0)) {
            throw new \InvalidArgumentException('invalid length for $returnMethod when calling MerchantShipmentTrackingRequest., must be bigger than or equal to 0.');
        }
