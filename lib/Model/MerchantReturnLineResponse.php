...
class MerchantReturnLineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SHIPMENT_STATUS_IN_BACKORDER = 'IN_BACKORDER';
    public const SHIPMENT_STATUS_MANCO = 'MANCO';
    ...
    public function getShipmentStatusAllowableValues()
    {
        return [
            ...
            self::SHIPMENT_STATUS_IN_BACKORDER,
            self::SHIPMENT_STATUS_MANCO,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipmentStatus']) && !in_array($this->container['shipmentStatus'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'shipmentStatus', must be one of '%s'",
                $this->container['shipmentStatus'],
     ...
     * Sets shipmentStatus
     *
     * @param string|null $shipmentStatus The status of the product in relation to the shipment.
     *
     * @return self
     */
    public function setShipmentStatus($shipmentStatus)
    {
        if (is_null($shipmentStatus)) {
            array_push($this->openAPINullablesSetToNull, 'shipmentStatus');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipmentStatus', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int|null $acceptedQuantity The quantity of the return that has been marked as accepted.
     *
     * @return self
     */
    public function setAcceptedQuantity($acceptedQuantity)
    {
        if (is_null($acceptedQuantity)) {
            throw new \InvalidArgumentException('non-nullable acceptedQuantity cannot be null');
        }
     ...
     *
     * @param int|null $rejectedQuantity The quantity of the return that has been marked as rejected.
     *
     * @return self
     */
    public function setRejectedQuantity($rejectedQuantity)
    {
        if (is_null($rejectedQuantity)) {
            throw new \InvalidArgumentException('non-nullable rejectedQuantity cannot be null');
        }
