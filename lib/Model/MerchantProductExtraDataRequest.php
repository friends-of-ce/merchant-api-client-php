...
/**
 * MerchantProductExtraDataRequest Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MerchantProductExtraDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantProductExtraDataRequest';
    ...
    protected static $openAPITypes = [
        ...
        'operations' => '\FriendsOfCE\Merchant\ApiClient\Model\ProductExtraDataRequest[]'
    ];
    ...
    */
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        ...
        if ((mb_strlen($merchantProductNo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling MerchantProductExtraDataRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets operations
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\ProductExtraDataRequest[]
     */
     ...
     * Sets operations
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\ProductExtraDataRequest[] $operations operations
     *
     * @return self
     */
