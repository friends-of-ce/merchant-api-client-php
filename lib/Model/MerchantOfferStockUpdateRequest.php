...
class MerchantOfferStockUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'stockLocations' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantStockLocationUpdateRequest[]'
    ];
    ...
    */
     ...
     * Gets stockLocations
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantStockLocationUpdateRequest[]
     */
     ...
     * Sets stockLocations
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantStockLocationUpdateRequest[] $stockLocations Stock locations data
     *
     * @return self
     */
    public function setStockLocations($stockLocations)
    {
        if (is_null($stockLocations)) {
            throw new \InvalidArgumentException('non-nullable stockLocations cannot be null');
        }
