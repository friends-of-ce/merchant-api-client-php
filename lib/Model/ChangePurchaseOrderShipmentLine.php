...
/**
 * ChangePurchaseOrderShipmentLine Class Doc Comment
 *
 * @category Class
 ...
 */
class ChangePurchaseOrderShipmentLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangePurchaseOrderShipmentLine';
    ...
    */
     ...
     * Sets channelOrderNo
     *
     * @param string $channelOrderNo Channel's identifier of the purchase order
     *
     * @return self
     */
    public function setChannelOrderNo($channelOrderNo)
    {
        if (is_null($channelOrderNo)) {
            throw new \InvalidArgumentException('non-nullable channelOrderNo cannot be null');
        }
        if ((mb_strlen($channelOrderNo) > 60)) {
            throw new \InvalidArgumentException('invalid length for $channelOrderNo when calling ChangePurchaseOrderShipmentLine., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($channelOrderNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $channelOrderNo when calling ChangePurchaseOrderShipmentLine., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $merchantProductNo Merchant's identifier of the product.  The combination of ChannelOrderNo + MerchantProductNo identifies the order line this shipment line  ships.
     *
     * @return self
     */
    public function setMerchantProductNo($merchantProductNo)
    {
        ...
        if ((mb_strlen($merchantProductNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling ChangePurchaseOrderShipmentLine., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($merchantProductNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling ChangePurchaseOrderShipmentLine., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int|null $quantityUnitSize The case size, when QuantityUnitOfMeasure is 'CASES'. Otherwise, it is 1.
     *
     * @return self
     */
