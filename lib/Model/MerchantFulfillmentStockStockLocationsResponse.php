...
/**
 * MerchantFulfillmentStockStockLocationsResponse Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MerchantFulfillmentStockStockLocationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantFulfillmentStockStockLocationsResponse';
    ...
    protected static $openAPITypes = [
        ...
        'stockLocations' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantFulfillmentStockLocationItemResponse[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('stockLocations', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $merchantProductNo The product SKU.
     *
     * @return self
     */
     ...
     * Gets stockLocations
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantFulfillmentStockLocationItemResponse[]|null
     */
     ...
     * Sets stockLocations
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantFulfillmentStockLocationItemResponse[]|null $stockLocations The ChannelEngine id of the stock location.
     *
     * @return self
     */
    public function setStockLocations($stockLocations)
    {
        if (is_null($stockLocations)) {
            array_push($this->openAPINullablesSetToNull, 'stockLocations');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('stockLocations', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
