 ...
 */
class ProductCreationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductCreationResult';
    ...
    protected static $openAPITypes = [
        'rejectedCount' => 'int',
        'acceptedCount' => 'int',
        'productMessages' => '\FriendsOfCE\Merchant\ApiClient\Model\ProductMessage[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('productMessages', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\ProductMessage[]|null
     */
     ...
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\ProductMessage[]|null $productMessages productMessages
     *
     * @return self
     */
    public function setProductMessages($productMessages)
    {
        if (is_null($productMessages)) {
            array_push($this->openAPINullablesSetToNull, 'productMessages');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('productMessages', $nullablesSetToNull);
            if ($index !== FALSE) {
