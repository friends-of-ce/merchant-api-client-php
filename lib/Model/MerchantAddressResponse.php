...
class MerchantAddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'line2' => 'setLine2',
        'line3' => 'setLine3',
        'pickupPointNumber' => 'setPickupPointNumber',
    ...
    protected static $getters = [
        ...
        'line2' => 'getLine2',
        'line3' => 'getLine3',
        'pickupPointNumber' => 'getPickupPointNumber',
    ...
    public const ADDRESS_TYPE_PACKSTATION = 'PACKSTATION';
    public const ADDRESS_TYPE_PICKUP_POINT = 'PICKUP_POINT';
    ...
    public function getAddressTypeAllowableValues()
    {
        return [
            ...
            self::ADDRESS_TYPE_PACKSTATION,
            self::ADDRESS_TYPE_PICKUP_POINT,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pickupPointNumber', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets pickupPointNumber
     *
     * @return string|null
     */
    public function getPickupPointNumber()
    {
        return $this->container['pickupPointNumber'];
    }

    /**
     * Sets pickupPointNumber
     *
     * @param string|null $pickupPointNumber The number of the pickup point.
     *
     * @return self
     */
    public function setPickupPointNumber($pickupPointNumber)
    {
        if (is_null($pickupPointNumber)) {
            array_push($this->openAPINullablesSetToNull, 'pickupPointNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickupPointNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pickupPointNumber'] = $pickupPointNumber;
     ...
     *
     * @param string|null $pickupPointName The name of the pickup point.
     *
     * @return self
     */
    public function setPickupPointName($pickupPointName)
    {
        if (is_null($pickupPointName)) {
            array_push($this->openAPINullablesSetToNull, 'pickupPointName');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickupPointName', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
