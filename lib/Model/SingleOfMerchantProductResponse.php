 ...
 */
class SingleOfMerchantProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleOfMerchantProductResponse';
