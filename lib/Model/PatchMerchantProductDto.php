...
class PatchMerchantProductDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'merchantProductRequestModels' => '\FriendsOfCE\Merchant\ApiClient\Model\MerchantProductRequest[]'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'merchantProductRequestModels' => true
    ];
    ...
    {
        $this->setIfExists('propertiesToUpdate', $data ?? [], null);
        $this->setIfExists('merchantProductRequestModels', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string[]|null $propertiesToUpdate Fields to update
     *
     * @return self
     */
    public function setPropertiesToUpdate($propertiesToUpdate)
    {
        if (is_null($propertiesToUpdate)) {
            array_push($this->openAPINullablesSetToNull, 'propertiesToUpdate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('propertiesToUpdate', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @return \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductRequest[]|null
     */
     ...
     *
     * @param \FriendsOfCE\Merchant\ApiClient\Model\MerchantProductRequest[]|null $merchantProductRequestModels Products to be updated
     *
     * @return self
     */
    public function setMerchantProductRequestModels($merchantProductRequestModels)
    {
        if (is_null($merchantProductRequestModels)) {
            array_push($this->openAPINullablesSetToNull, 'merchantProductRequestModels');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('merchantProductRequestModels', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
