 ...
 */
class ProductMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMessage';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('keyReference', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['keyReference'];
    }

    /**
     * Sets keyReference
     *
     * @param string|null $keyReference keyReference
     *
     * @return self
     */
    public function setKeyReference($keyReference)
    {
        if (is_null($keyReference)) {
            array_push($this->openAPINullablesSetToNull, 'keyReference');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('keyReference', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['keyReference'] = $keyReference;
