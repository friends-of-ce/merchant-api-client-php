...
class PurchaseOrderInvoiceTaxDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TAX_TYPE_MWST = 'MWST';
    ...
    public const TAX_TYPE_MUTUALLY_DEFINED = 'MUTUALLY_DEFINED';
    public const TAX_TYPE_DOMESTIC_VAT = 'DOMESTIC_VAT';
    ...
    */
     ...
     * Sets taxType
     *
     * @param string|null $taxType taxType
     *
     * @return self
     */
    public function setTaxType($taxType)
    {
        ...
        $allowedValues = $this->getTaxTypeAllowableValues();
        if (!is_null($taxType) && !in_array($taxType, $allowedValues, true)) {
