...
class MerchantSettlementReportsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'reserveMutationAmount' => 'ReserveMutationAmount',
    ...
    protected static $setters = [
        ...
        'reserveMutationAmount' => 'setReserveMutationAmount',
    ...
    protected static $getters = [
        ...
        'reserveMutationAmount' => 'getReserveMutationAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reserveMutationAmount', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets reserveMutationAmount
     *
     * @return float|null
     */
    public function getReserveMutationAmount()
    {
        return $this->container['reserveMutationAmount'];
    }

    /**
     * Sets reserveMutationAmount
     *
     * @param float|null $reserveMutationAmount reserveMutationAmount
     *
     * @return self
     */
    public function setReserveMutationAmount($reserveMutationAmount)
    {
        if (is_null($reserveMutationAmount)) {
            array_push($this->openAPINullablesSetToNull, 'reserveMutationAmount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reserveMutationAmount', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reserveMutationAmount'] = $reserveMutationAmount;
