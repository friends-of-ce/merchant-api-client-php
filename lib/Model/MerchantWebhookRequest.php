...
class MerchantWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENTS_ORDERS_CREATE = 'ORDERS_CREATE';
    public const EVENTS_PRODUCTS_CHANGE = 'PRODUCTS_CHANGE';
    public const EVENTS_RETURNS_CHANGE = 'RETURNS_CHANGE';
    public const EVENTS_SHIPMENTS_CHANGE = 'SHIPMENTS_CHANGE';
    public const EVENTS_NOTIFICATIONS_CREATE = 'NOTIFICATIONS_CREATE';
    public const EVENTS_BUNDLE_PRODUCTS_CHANGE = 'BUNDLE_PRODUCTS_CHANGE';
    public const EVENTS_ORDERS_CHANGE = 'ORDERS_CHANGE';
    ...
    {
        return [
            self::EVENTS_ORDERS_CREATE,
            self::EVENTS_PRODUCTS_CHANGE,
            self::EVENTS_RETURNS_CHANGE,
            self::EVENTS_SHIPMENTS_CHANGE,
            self::EVENTS_NOTIFICATIONS_CREATE,
            self::EVENTS_BUNDLE_PRODUCTS_CHANGE,
            self::EVENTS_ORDERS_CHANGE,
        ];
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The unique name of a webhook.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The callback URL used by a webhook. E.g.: https://test-store.com/callback.
     *
     * @return self
     */
     ...
     * Sets isActive
     *
     * @param bool|null $isActive Determines if a webhook is active, and callbacks should proceed.
     *
     * @return self
     */
     ...
     * Sets requestType
     *
     * @param string|null $requestType Sets the type of request webhook makes.
     *
     * @return self
     */
    public function setRequestType($requestType)
    {
        if (is_null($requestType)) {
            array_push($this->openAPINullablesSetToNull, 'requestType');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requestType', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $allowedValues = $this->getRequestTypeAllowableValues();
        if (!is_null($requestType) && !in_array($requestType, $allowedValues, true)) {
     ...
     * Sets events
     *
     * @param string[] $events The events supported by the webhook.
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling MerchantWebhookRequest., number of items must be greater than or equal to 1.');
        }
