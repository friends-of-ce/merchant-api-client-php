    ...
    */
    ...
    public function setBillOfLadingNumber($billOfLadingNumber)
    {
        ...
        if (!is_null($billOfLadingNumber) && (mb_strlen($billOfLadingNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $billOfLadingNumber when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($billOfLadingNumber) && (mb_strlen($billOfLadingNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $billOfLadingNumber when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
