...
/**
 * UpdatePurchaseOrderShipment Class Doc Comment
 *
 * @category Class
 * @package  FriendsOfCE\Merchant\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePurchaseOrderShipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePurchaseOrderShipment';
    ...
    */
    ...
    public function setMerchantShipmentNo($merchantShipmentNo)
    {
        ...
        if (!is_null($merchantShipmentNo) && (mb_strlen($merchantShipmentNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantShipmentNo when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantShipmentNo) && (mb_strlen($merchantShipmentNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantShipmentNo when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setCarrierShipmentNo($carrierShipmentNo)
    {
        ...
        if (!is_null($carrierShipmentNo) && (mb_strlen($carrierShipmentNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $carrierShipmentNo when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($carrierShipmentNo) && (mb_strlen($carrierShipmentNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrierShipmentNo when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setChannelShipmentNo($channelShipmentNo)
    {
        ...
        if (!is_null($channelShipmentNo) && (mb_strlen($channelShipmentNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $channelShipmentNo when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($channelShipmentNo) && (mb_strlen($channelShipmentNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $channelShipmentNo when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setBillOfLadingNo($billOfLadingNo)
    {
        ...
        if (!is_null($billOfLadingNo) && (mb_strlen($billOfLadingNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $billOfLadingNo when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($billOfLadingNo) && (mb_strlen($billOfLadingNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $billOfLadingNo when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setCarrierName($carrierName)
    {
        ...
        if (!is_null($carrierName) && (mb_strlen($carrierName) > 64)) {
            throw new \InvalidArgumentException('invalid length for $carrierName when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 64.');
        }
        if (!is_null($carrierName) && (mb_strlen($carrierName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrierName when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setSellingPartyId($sellingPartyId)
    {
        ...
        if (!is_null($sellingPartyId) && (mb_strlen($sellingPartyId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sellingPartyId when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 50.');
        }
        if (!is_null($sellingPartyId) && (mb_strlen($sellingPartyId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sellingPartyId when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setShipFromPartyId($shipFromPartyId)
    {
        ...
        if (!is_null($shipFromPartyId) && (mb_strlen($shipFromPartyId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shipFromPartyId when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 50.');
        }
        if (!is_null($shipFromPartyId) && (mb_strlen($shipFromPartyId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipFromPartyId when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
    ...
    public function setShipToPartyId($shipToPartyId)
    {
        ...
        if (!is_null($shipToPartyId) && (mb_strlen($shipToPartyId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shipToPartyId when calling UpdatePurchaseOrderShipment., must be smaller than or equal to 50.');
        }
        if (!is_null($shipToPartyId) && (mb_strlen($shipToPartyId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipToPartyId when calling UpdatePurchaseOrderShipment., must be bigger than or equal to 0.');
        }
