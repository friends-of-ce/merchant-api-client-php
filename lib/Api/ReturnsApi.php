...
class ReturnsApi
{
     ...
     * @param  ReturnIdentifier $type Specify whether to search by ID, Merchant Return No or Channel Return No (optional)
     ...
     *
     * @param  ReturnByFilterIdentifier $identifiersIdentifierType The type of identifier: which identifier to filter on (optional)
     ...
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\ModuleReturnReason[] $reasons reasons (optional)
     ...
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\ModuleReturnStatus[] $statuses statuses (optional)
     ...
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\ModuleReturnReason[] $reasons (optional)
     * @param  \DateTime $createdDateRangeFromDate (optional)
     * @param  \DateTime $createdDateRangeToDate (optional)
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\ModuleReturnStatus[] $statuses (optional)
