...
class ProductsApi
{
     ...
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Merchant\ApiClient\Model\SingleOfProductCreationResult|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Merchant\ApiClient\Model\SingleOfProductCreationResult|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productFreeze'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Merchant\ApiClient\Model\SingleOfApiResponse
     */
    public function productFreeze($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {
        list($response) = $this->productFreezeWithHttpInfo($freezeProductRequest, $contentType);
        return $response;
    }

    /**
     * Operation productFreezeWithHttpInfo
     *
     * Updates selected products and sets them either to frozen or not-frozen status.
     *
     ...
     */
    public function productFreezeWithHttpInfo($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {
        $request = $this->productFreezeRequest($freezeProductRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productFreezeAsync($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {
        return $this->productFreezeAsyncWithHttpInfo($freezeProductRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productFreezeAsyncWithHttpInfo
     *
     * Updates selected products and sets them either to frozen or not-frozen status.
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\FreezeProductRequest[] $freezeProductRequest (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productFreezeAsyncWithHttpInfo($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\SingleOfApiResponse';
        $request = $this->productFreezeRequest($freezeProductRequest, $contentType);
    ...
    /**
     * Create request for operation 'productFreeze'
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\FreezeProductRequest[] $freezeProductRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productFreeze'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productFreezeRequest($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {



        $resourcePath = '/v2/products/freeze';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function productGetByFilter($search = null, $eanList = null, $merchantProductNoList = null, $pageSize = null, $page = null, string $contentType = self::contentTypes['productGetByFilter'][0])
    {
        list($response) = $this->productGetByFilterWithHttpInfo($search, $eanList, $merchantProductNoList, $pageSize, $page, $contentType);
        return $response;
    }
     ...
     */
    public function productGetByFilterWithHttpInfo($search = null, $eanList = null, $merchantProductNoList = null, $pageSize = null, $page = null, string $contentType = self::contentTypes['productGetByFilter'][0])
    {
        $request = $this->productGetByFilterRequest($search, $eanList, $merchantProductNoList, $pageSize, $page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetByFilterAsync($search = null, $eanList = null, $merchantProductNoList = null, $pageSize = null, $page = null, string $contentType = self::contentTypes['productGetByFilter'][0])
    {
        return $this->productGetByFilterAsyncWithHttpInfo($search, $eanList, $merchantProductNoList, $pageSize, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productGetByFilterAsyncWithHttpInfo($search = null, $eanList = null, $merchantProductNoList = null, $pageSize = null, $page = null, string $contentType = self::contentTypes['productGetByFilter'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\CollectionOfMerchantProductResponse';
        $request = $this->productGetByFilterRequest($search, $eanList, $merchantProductNoList, $pageSize, $page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productGetByFilterRequest($search = null, $eanList = null, $merchantProductNoList = null, $pageSize = null, $page = null, string $contentType = self::contentTypes['productGetByFilter'][0])
    {
    ...
    /**
     * Operation productV21Create
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Create or update a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantUpsertProductRequest $singleMerchantUpsertProductRequest The product data to upsert (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Create'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse
     */
    public function productV21Create($singleMerchantUpsertProductRequest = null, string $contentType = self::contentTypes['productV21Create'][0])
    {
        list($response) = $this->productV21CreateWithHttpInfo($singleMerchantUpsertProductRequest, $contentType);
        return $response;
    }

    /**
     * Operation productV21CreateWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Create or update a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantUpsertProductRequest $singleMerchantUpsertProductRequest The product data to upsert (optional)
     ...
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productV21CreateWithHttpInfo($singleMerchantUpsertProductRequest = null, string $contentType = self::contentTypes['productV21Create'][0])
    {
        $request = $this->productV21CreateRequest($singleMerchantUpsertProductRequest, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation productV21CreateAsync
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Create or update a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantUpsertProductRequest $singleMerchantUpsertProductRequest The product data to upsert (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21CreateAsync($singleMerchantUpsertProductRequest = null, string $contentType = self::contentTypes['productV21Create'][0])
    {
        return $this->productV21CreateAsyncWithHttpInfo($singleMerchantUpsertProductRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productV21CreateAsyncWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Create or update a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantUpsertProductRequest $singleMerchantUpsertProductRequest The product data to upsert (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21CreateAsyncWithHttpInfo($singleMerchantUpsertProductRequest = null, string $contentType = self::contentTypes['productV21Create'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse';
        $request = $this->productV21CreateRequest($singleMerchantUpsertProductRequest, $contentType);
    ...
    /**
     * Create request for operation 'productV21Create'
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantUpsertProductRequest $singleMerchantUpsertProductRequest The product data to upsert (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Create'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productV21CreateRequest($singleMerchantUpsertProductRequest = null, string $contentType = self::contentTypes['productV21Create'][0])
    {



        $resourcePath = '/v2.1/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($singleMerchantUpsertProductRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($singleMerchantUpsertProductRequest));
            } else {
                $httpBody = $singleMerchantUpsertProductRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation productV21Delete
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Delete a product
     *
     * @param  string $asyncApiProductIdentifierType The type of identifier to use (optional)
     * @param  string $productIdentifier The identifier of the product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Delete'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse
     */
    public function productV21Delete($asyncApiProductIdentifierType = null, $productIdentifier = null, string $contentType = self::contentTypes['productV21Delete'][0])
    {
        list($response) = $this->productV21DeleteWithHttpInfo($asyncApiProductIdentifierType, $productIdentifier, $contentType);
        return $response;
    }

    /**
     * Operation productV21DeleteWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Delete a product
     *
     * @param  string $asyncApiProductIdentifierType The type of identifier to use (optional)
     ...
     * @return array of \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productV21DeleteWithHttpInfo($asyncApiProductIdentifierType = null, $productIdentifier = null, string $contentType = self::contentTypes['productV21Delete'][0])
    {
        $request = $this->productV21DeleteRequest($asyncApiProductIdentifierType, $productIdentifier, $contentType);
    ...
    /**
     * Operation productV21DeleteAsync
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Delete a product
     *
     * @param  string $asyncApiProductIdentifierType The type of identifier to use (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21DeleteAsync($asyncApiProductIdentifierType = null, $productIdentifier = null, string $contentType = self::contentTypes['productV21Delete'][0])
    {
        return $this->productV21DeleteAsyncWithHttpInfo($asyncApiProductIdentifierType, $productIdentifier, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productV21DeleteAsyncWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Delete a product
     *
     * @param  string $asyncApiProductIdentifierType The type of identifier to use (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21DeleteAsyncWithHttpInfo($asyncApiProductIdentifierType = null, $productIdentifier = null, string $contentType = self::contentTypes['productV21Delete'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse';
        $request = $this->productV21DeleteRequest($asyncApiProductIdentifierType, $productIdentifier, $contentType);
    ...
    /**
     * Create request for operation 'productV21Delete'
     *
     * @param  string $asyncApiProductIdentifierType The type of identifier to use (optional)
     * @param  string $productIdentifier The identifier of the product (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Delete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productV21DeleteRequest($asyncApiProductIdentifierType = null, $productIdentifier = null, string $contentType = self::contentTypes['productV21Delete'][0])
    {
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $asyncApiProductIdentifierType,
            'asyncApiProductIdentifierType', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $productIdentifier,
            'productIdentifier', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation productV21Patch
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Update part of a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantPatchProductRequest $singleMerchantPatchProductRequest The product updates to be made (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Patch'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse
     */
    public function productV21Patch($singleMerchantPatchProductRequest = null, string $contentType = self::contentTypes['productV21Patch'][0])
    {
        list($response) = $this->productV21PatchWithHttpInfo($singleMerchantPatchProductRequest, $contentType);
        return $response;
    }

    /**
     * Operation productV21PatchWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Update part of a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantPatchProductRequest $singleMerchantPatchProductRequest The product updates to be made (optional)
     ...
     * @return array of \FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse|\FriendsOfCE\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productV21PatchWithHttpInfo($singleMerchantPatchProductRequest = null, string $contentType = self::contentTypes['productV21Patch'][0])
    {
        $request = $this->productV21PatchRequest($singleMerchantPatchProductRequest, $contentType);
    ...
    /**
     * Operation productV21PatchAsync
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Update part of a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantPatchProductRequest $singleMerchantPatchProductRequest The product updates to be made (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21PatchAsync($singleMerchantPatchProductRequest = null, string $contentType = self::contentTypes['productV21Patch'][0])
    {
        return $this->productV21PatchAsyncWithHttpInfo($singleMerchantPatchProductRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productV21PatchAsyncWithHttpInfo
     *
     * [CLOSED BETA - AUTHORIZED USERS ONLY] Update part of a product
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantPatchProductRequest $singleMerchantPatchProductRequest The product updates to be made (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productV21PatchAsyncWithHttpInfo($singleMerchantPatchProductRequest = null, string $contentType = self::contentTypes['productV21Patch'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\AsyncApiResponse';
        $request = $this->productV21PatchRequest($singleMerchantPatchProductRequest, $contentType);
    ...
    /**
     * Create request for operation 'productV21Patch'
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\SingleMerchantPatchProductRequest $singleMerchantPatchProductRequest The product updates to be made (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productV21Patch'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productV21PatchRequest($singleMerchantPatchProductRequest = null, string $contentType = self::contentTypes['productV21Patch'][0])
    {
        ...
        // for model (json/xml)
        if (isset($singleMerchantPatchProductRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($singleMerchantPatchProductRequest));
            } else {
                $httpBody = $singleMerchantPatchProductRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
