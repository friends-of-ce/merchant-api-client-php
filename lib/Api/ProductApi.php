...
/**
     ...
     * @return \FriendsOfCE\Merchant\ApiClient\Model\SingleOfProductCreationResult
     */
    public function productCreate($merchantProductRequest, $ignoreStock = false, string $contentType = self::contentTypes['productCreate'][0])
    {
        list($response) = $this->productCreateWithHttpInfo($merchantProductRequest, $ignoreStock, $contentType);
        return $response;
    }
     ...
     * @return array of \FriendsOfCE\Merchant\ApiClient\Model\SingleOfProductCreationResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function productCreateWithHttpInfo($merchantProductRequest, $ignoreStock = false, string $contentType = self::contentTypes['productCreate'][0])
    {
        $request = $this->productCreateRequest($merchantProductRequest, $ignoreStock, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productCreateAsync($merchantProductRequest, $ignoreStock = false, string $contentType = self::contentTypes['productCreate'][0])
    {
        return $this->productCreateAsyncWithHttpInfo($merchantProductRequest, $ignoreStock, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productCreateAsyncWithHttpInfo($merchantProductRequest, $ignoreStock = false, string $contentType = self::contentTypes['productCreate'][0])
    {
        $returnType = '\FriendsOfCE\Merchant\ApiClient\Model\SingleOfProductCreationResult';
        $request = $this->productCreateRequest($merchantProductRequest, $ignoreStock, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productCreateRequest($merchantProductRequest, $ignoreStock = false, string $contentType = self::contentTypes['productCreate'][0])
    {
