...
class SettlementsApi
{
     ...
     * Gets settlements
     *
     * @param  bool $unExportedOnly Deprecated! Use IsExported instead. &lt;br /&gt;Filter on settlements that have not been exported before. (optional)
     * @param  bool $isExported Filter on settlements that have not been exported before. (optional)
     ...
     */
    public function settlementGetByFilter($unExportedOnly = null, $isExported = null, $settlementIds = null, $channelSettlementNos = null, $channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
        list($response) = $this->settlementGetByFilterWithHttpInfo($unExportedOnly, $isExported, $settlementIds, $channelSettlementNos, $channelIds, $fromStartDate, $toStartDate, $fromEndDate, $toEndDate, $fromCreateDate, $toCreateDate, $fromUpdateDate, $toUpdateDate, $page, $contentType);
        return $response;
    }
     ...
     */
    public function settlementGetByFilterWithHttpInfo($unExportedOnly = null, $isExported = null, $settlementIds = null, $channelSettlementNos = null, $channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
        $request = $this->settlementGetByFilterRequest($unExportedOnly, $isExported, $settlementIds, $channelSettlementNos, $channelIds, $fromStartDate, $toStartDate, $fromEndDate, $toEndDate, $fromCreateDate, $toCreateDate, $fromUpdateDate, $toUpdateDate, $page, $contentType);
     ...
     */
    public function settlementGetByFilterAsync($unExportedOnly = null, $isExported = null, $settlementIds = null, $channelSettlementNos = null, $channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
        return $this->settlementGetByFilterAsyncWithHttpInfo($unExportedOnly, $isExported, $settlementIds, $channelSettlementNos, $channelIds, $fromStartDate, $toStartDate, $fromEndDate, $toEndDate, $fromCreateDate, $toCreateDate, $fromUpdateDate, $toUpdateDate, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function settlementGetByFilterRequest($unExportedOnly = null, $isExported = null, $settlementIds = null, $channelSettlementNos = null, $channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
     ...
     *
     * @param  \SplFileObject $settlement The settlement file must not exceed 1MB in size.  Use the file format originally provided by the marketplace (usually CSV). (required)
     * @param  int $channelId The channel ID of the channel which the settlement is for. (optional)
