...
class OrdersApi
{
     ...
     *
     * @param  string[] $statuses Order status(es) to filter on. AWAITING_PAYMENT orders will be excluded if it is not included in this Statuses filter. (optional)
     ...
     * @param  string[] $commercialOrderNos Filter on commercial order numbers. (optional)
     ...
     * @param  \DateTime $toAcknowledgedDate Filter on the order acknowledged date, until this date. This date is exclusive. (optional)
     * @param  \DateTime $fromClosedAtDate Filter on the order ClosedAt date, starting from this date. This date is inclusive. (optional)
     * @param  \DateTime $toClosedAtDate Filter on the order ClosedAt date, until this date. This date is exclusive. (optional)
     ...
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\BulkMerchantMarkExportAsFailedForOrdersRequest $bulkMerchantMarkExportAsFailedForOrdersRequest bulkMerchantMarkExportAsFailedForOrdersRequest (optional)
     ...
     *
     * @param  \FriendsOfCE\Merchant\ApiClient\Model\BulkMerchantMarkExportAsFailedForOrdersRequest $bulkMerchantMarkExportAsFailedForOrdersRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['orderMarkExportAsFailed'] to see the possible values for this operation
     *
     * @throws \FriendsOfCE\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
